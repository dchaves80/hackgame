  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-sm">
        ...
        {/* Login box - with drawing animation */}
            ...
            <div className={`p-6 transition-opacity duration-500 ${showContent ? 'opacity-100' : 'opacity-0'}`}>
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-cyber-500 tracking-wider">ACCESS TERMINAL</span>
                </div>
              ...
              <div className="mt-4 text-center">
                ...
                >
                  NEW USER? <span className="text-cyber-500">REGISTER</span>
                </Link>
              </div>
